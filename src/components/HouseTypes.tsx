...
export function HouseTypes({}: Props) {
  ...
  return (
    <div className="fixed z-50 w-full bg-white border-b shadow-sm border-b-stone-200" style={{top: "83px"}}>
      <div
        className="relative px-5 mt-4 mb-2 ml-5 overflow-hidden h-14"
      ...
      >
        ...
        {currScreenWidth &&
          Math.abs(scrollIndex) * currScreenWidth <
            houseTypesContainerWidth + currScreenWidth / 5 && (
